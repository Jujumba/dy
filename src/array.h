...
do {                                                                                              \
    ...
    u32 ___array_additional_cap = (array)->header.cap != 0 ? (array)->header.cap : INITIAL_CAP;   \
    ...
    void* ___array_new_buffer = ArenaAlloc(arena, ___array_new_cap * sizeof(* (array)->buffer));  \
